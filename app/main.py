...
@app.get("/items/{item_id}", response_model=ItemDisplay)
...
@app.put("/items/{item_id}", response_model=ItemDisplay)
...
@app.post("/carts/{cart_id}/items", response_model=CartItemDisplay)
def add_item_to_cart(
    cart_id: int, cart_item: CartItemCreate, db: Session = Depends(get_db)
):
...
def remove_item_from_cart(
    cart_id: int,
    remove_request: CartItemRemoveRequest,
